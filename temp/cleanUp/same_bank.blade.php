            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <img src="{{ asset('assets/images/Hello.png') }}" class="img-fluid" alt=""
                                style="opacity: 0.8;">
                        </div> <!-- end col -->
                    </div>
                    <!-- end row -->
                    <button class="btn btn-primary" type="submit" id="payment_submit" data-toggle="modal"
                        data-target="#multiple-one">Next</button>
                        ...
                        <div class="modal-content">
                            <form action="POST" id="confirm_details" autocomplete="off" aria-autocomplete="off">
                                ...
                                <div class="modal-body">
                                    {{--  <h5 class="mt-0">Text in a modal</h5>  --}}
                                    {{--  <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula.</p>  --}}
                                    From: &nbsp; <span class="font-18 text-primary" id="display_from_account"> &nbsp
                                    </span><br><br>
                                    To: &nbsp; <span class="font-18 text-muted" id="display_to_account"> &nbsp
                                    </span><br><br>
                                    Schedule Payment: &nbsp; <span class="font-18 text-muted" id="display_payments">
                                        &nbsp </span><br><br>
                                    One Time Payment: &nbsp; <span class="font-18 text-muted" id="display_payments2">
                                        &nbsp </span><br><br>
                                    Amount: &nbsp; <span class="font-18 text-muted" id="display_amount"> &nbsp
                                    </span><br><br>
                                    Naration: &nbsp; <span class="font-18 text-muted" id="display_naration"> &nbsp
                                    </span><br><br>
                                    Transaction fee: &nbsp; <span class="font-18 text-muted"
                                        id="display_trasaction_fee"> </span><br><br>
                                    Total: &nbsp; <span class="font-18 text-muted" id="display_total"> &nbsp
                                    </span><br><br>
